/*
 * ─── NOIR GOURMAND — HOMEPAGE ─────────────────────────────────
 *
 * Design Direction: "Noir Gourmand" — editorial-luxury food
 * magazine aesthetic. Wine-bar sophistication meets artisan warmth.
 *
 * Palette:       Burgundy #7B2D3B · Gold #C8956C · Ink #1C1917
 *                Ivory #FAF7F2 · Rose #A8727D · Parchment #F0EBE3
 * Typography:    Cormorant Garamond (display) + Outfit (body)
 * Card Style:    Parchment surfaces, warm shadow, rounded-[14px],
 *                hover-lift effect — no dashed borders.
 * ──────────────────────────────────────────────────────────────
 */

import { getFeaturedRecipes } from '@/lib/mock-data'
...
export default async function HomePage() {
    const latestRecipes = getFeaturedRecipes(8)
    const trendingRecipes = getFeaturedRecipes(8)
