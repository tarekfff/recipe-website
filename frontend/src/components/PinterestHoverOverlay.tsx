...
export default function PinterestHoverOverlay() {
    ...
    return (
        <div id="pinterest-overlay-btn"
           ...
           style={{
               top: Math.max(0, rect.top) + (rect.height / 2) - 40, // Perfect vertical center (40 is half of the new 80px wrapper)
               left: rect.left + (rect.width / 2) - 40, // Perfect horizontal center
           }}
        ...
        >
            <a href={pinterestUrl}
               ...
               className="flex items-center justify-center w-14 h-14 rounded-full bg-[#E60023] hover:bg-[#ad081b] text-white shadow-xl transition-all duration-200 hover:scale-110 drop-shadow-md"
            >
