        ...
        <div className="min-h-screen bg-cream">
            ...
            <main className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <h1 className="font-display text-4xl font-bold text-gray-900 mb-3">Browse Categories</h1>
                    <p className="text-gray-500 text-lg">{categories.length} categories to explore</p>
                </div>
                            ...
                            <div className="aspect-video bg-gradient-to-br from-brand-50 to-brand-100 relative overflow-hidden">
                                {cat.image ? (
                                    ...
                                    <div className="w-full h-full flex items-center justify-center">
                                        <FolderOpen className="w-10 h-10 text-brand-300" />
                                    </div>
                                )}
                            </div>
                            <div className="p-4">
                                ...
                                <div className="flex items-center justify-between mt-2">
                                    <span className="text-xs text-gray-400">{cat._count.recipes} recipes</span>
                                    <ArrowRight className="w-3.5 h-3.5 text-gray-300 group-hover:text-brand-500 group-hover:translate-x-1 transition-all" />
                                </div>
                            </div>
                        </Link>
                    ))}
